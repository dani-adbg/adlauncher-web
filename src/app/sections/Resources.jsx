  ...
  return (
    <div id="downloads" className="bg-gray flex flex-col items-center pb-[6vh]">
      ...
      <div className="flex flex-col justify-center my-[2vh] bg-black w-[70vh] h-[30vh] px-[10vh] rounded-xl">
        <a href="https://github.com/dani-adbg/adlauncher/releases/download/2.0.1/adlauncher-win32-x64-v2.0.1.zip" className="my-2 bg-gray rounded-lg h-[5vh] flex items-center px-[2vh] hover:bg-black cursor-pointer transition ease-linear delay-200">Descarga el .zip (Recomendado)</a>
